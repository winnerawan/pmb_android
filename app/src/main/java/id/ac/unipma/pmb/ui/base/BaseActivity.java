...
import id.ac.unipma.pmb.di.component.DaggerActivityComponent;
import id.ac.unipma.pmb.utils.CommonUtils;
import id.ac.unipma.pmb.utils.NetworkUtils;
...
public abstract class BaseActivity extends AppCompatActivity
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mActivityComponent = DaggerActivityComponent.builder()
                ...
                .applicationComponent(((PMB) getApplication()).getComponent())
                .build();
    ...
    public void onError(String message) {
        if (message != null) {
            ...
            showSnackBar(getString(id.ac.unipma.pmb.R.string.some_error));
        }
    }
    ...
    public void showMessage(String message) {
        if (message != null) {
            ...
            Toast.makeText(this, getString(id.ac.unipma.pmb.R.string.some_error), Toast.LENGTH_SHORT).show();
        }
    }
